...
pub enum EscrowError {
    ...
    /// Assigned a dedicated append-only code after the original range was exhausted.
    NoPendingAdmin = 250,
    ...
    InboundRecipientBalanceDeltaMismatch = 253,
    ...
    RegistryImmutableAfterFunding = 260,
    ...
    /// funding closes.
    BeneficiaryImmutableAfterFunding = 261,
